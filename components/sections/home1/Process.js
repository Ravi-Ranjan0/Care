          ...
          >
            <div className="inner-box">
              ...
              <div className="lower-content">
                ...
                <p>
                  Schedule your visit easily for personalized healthcare
                  solutions.{" "}
                </p>
              </div>
            </div>
          ...
          >
            <div className="inner-box">
              ...
              <div className="lower-content">
                ...
                <p>
                  Begin your health journey with a comprehensive evaluation
                  today.{" "}
                </p>
              </div>
            </div>
          ...
          >
            <div className="inner-box">
              ...
              <div className="lower-content">
                ...
                <p>
                  Embrace wellness and vitality with ongoing care and support.{" "}
                </p>
              </div>
            </div>
          </div>
